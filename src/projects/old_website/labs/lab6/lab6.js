...
$(document).ready(function () {
   ...
   $('h1').click(function () {
      $('em').text("Ghea Chaw");
      $('h1').css("font-variant","small-caps"); //im assuming small caps means "small caps" not lowercase
      $('h1').css("color","magenta");
      $('h1').css("font-size","110%");
   });
   ...
   $('#AddListItem').click(function () {
     ...
     $("#labList").append("<li>List item "+size+" </li>");
   });
